...
def PredictLabelsFromTestData(testData, noOfClasses, mu, e_faces, trainingWeights, testLabels, trainingLabels, classMap, thresholdDistance, noOfDimensions, k):
...
def main(arg):
    ...
    accuracy = PredictLabelsFromTestData(testData, noOfClasses, mu, e_faces, trainingWeights, testLabels, trainingLabels, classMap, thresholdDistance, noOfDimensions, k)
    return accuracy
